...
export interface UserProfile {
  name: string
  /** Set only after the user customizes their avatar in a room */
  customizedAvatar?: Avatar
}

const STORAGE_KEY = 'planning-poker-profile'
...
/** Avatar to send when joining — only if the user previously customized one */
