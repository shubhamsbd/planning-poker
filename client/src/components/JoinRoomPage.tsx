      ...
      <div className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-4 py-10">
        <div className="panel-accent rounded-3xl p-8 text-center">
          ...
          <p className="text-muted mt-2">
            Room <span className="font-mono text-brand-yellow-dark">{roomId}</span> does not exist
            or has been closed.
          </p>
          <Link
            href="/"
      ...
      <div className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-4 py-10">
        <div className="panel-accent rounded-3xl p-8 text-center">
          ...
          <p className="text-muted mt-2">
            ...
            {roomInfo.maxParticipants} participants (host + 10 teammates).
          </p>
          <Link
            href="/"
            className="btn-primary mt-6 inline-block rounded-xl px-5 py-3 text-sm font-semibold"
    ...
    <div className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-4 py-10">
      <div className="panel-accent rounded-3xl p-8">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-brand-black">Join planning poker</h1>
          <p className="text-muted mt-2">
