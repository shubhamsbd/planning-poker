    ...
    <div className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-4 py-10">
      <div className="panel-accent rounded-3xl p-8">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-brand-black">Sprint Planning Poker</h1>
          <p className="text-muted mt-2">
            Estimate stories together in real time with your scrum team.
          </p>
          <p className="text-subtle mt-1 text-xs">Up to 11 people per room (host + 10 teammates)</p>
        </div>
        ...
        <div className="mb-6 grid grid-cols-2 gap-2 rounded-2xl border border-black/8 bg-brand-gray p-1">
          <button
            ...
            className={`rounded-xl px-4 py-2 text-sm font-medium transition ${mode === 'create'
          ...
          <button
            ...
            className={`rounded-xl px-4 py-2 text-sm font-medium transition ${mode === 'join'
                ? 'bg-brand-yellow-light text-brand-black shadow-sm'
                : 'text-muted hover:text-brand-black'
              }`}
          >
            ...
            <>
              ...
              {passwordProtected && (
                <label className="block">
                  ...
                  />
                  <span className="text-subtle mt-1 block text-xs">
                    Share the invite link and this password with your team separately.
                  </span>
                </label>
              )}
            </>
